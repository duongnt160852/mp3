                ...
                <form action="admin/user/edit/{{$user->id}}" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Họ tên</label>
                                                <input type="text" class="form-control border-input" name="name" required="" value="">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">Email</label> <!--Email-->
                                                <input type="email" class="form-control border-input" name='email' value="">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group" >
                                        ...
                                        <div class="row"> 
                                                <div class="col-xs-4 col-md-4">
                                                    ...
                                                    <input class="form-control border-input" name="year" require=""  type="text" id="year" value="">
                                                </div>
                                                <div class="col-xs-4 col-md-4">
                                                    <div>
                                                        <label>Tháng</label>
