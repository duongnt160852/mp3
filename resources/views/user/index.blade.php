	...
	<section>
							...
							<div class="sign">
								...
								<div class="sign-right">
									<form action="#" method="post">
										...
										<input type="text" value="Mobile number" required="">
										<input type="text" value="Email id"required="">	
		...
		<div class="main-content">
			...
			<div class="header-section ">
				<div class="row ">
					...
					<div class="col-md-4 col-sm-4 login-pop">
							<div id="loginpop">
								<a href="#" id="loginButton"><span>ĐĂNG NHẬP <i class="arrow glyphicon glyphicon-chevron-right"></i></span></a>
								<a class="top-sign" href="#"><i class="fa fa-sign-in"></i></a>
								<div id="loginBox">  
									...
									<input type="hidden" name="_token" value="{{csrf_token()}}">
										<fieldset id="body">
											...
											<fieldset>
												...
												<div style="display:none" class="alert-danger" id="fail">Đăng nhập thất bại</div>
											<input type="button" id="login" value="Đăng nhập">
											<label for="checkbox"><input type="checkbox" id="checkbox"> <i>Ghi nhớ</i></label>
										</fieldset>
										<span><a href="#" data-toggle="modal" data-target="#myModal5">Đăng ký</a></span>
        ...
        $(document).ready(function(){
					$('#login').click(function(){
						$.get("ajax/login/"+$('#username').val()+"/"+$("#password").val(),function(data){
